      ...
      >
        <div className="flex flex-col h-full">
            ...
            {navigation.map((item) => {
              ...
              return (
                <Button
                  ...
                  className={cn(
                    "w-full flex items-center gap-3 font-medium transition-all duration-300 justify-start", // always left-aligned
                ...
                >
                  ...
                  <span
                    className={cn(
                      ...
                      sidebarCollapsed && isDesktop
                        ? "opacity-0 max-w-0 overflow-hidden" // smooth fade + width shrink
          ...
          {isDesktop && sidebarCollapsed ? (
            // collapsed: only avatar with popover
