    ...
    >
      ...
      <section className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
        ...
        <div className="flex items-center gap-4 mt-4 sm:mt-0">
          <button className="px-4 py-2 flex items-center gap-2 border rounded-md px-4 py-2 text-sm hover:bg-primary/90 transition duration-300 hover:text-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {[
          { title: "Present Today", value: 85, desc: "Out of 100 employees", color: "text-green-600" },
          { title: "Late Arrivals", value: 8, desc: "After 9:00 AM", color: "text-amber-500" },
          { title: "Absent", value: 4, desc: "Unexcused absences", color: "text-red-500" },
          { title: "On Leave", value: 3, desc: "Approved leave", color: "text-indigo-500" },
        ].map((item, i) => (
          <div
            key={i}
      ...
      <div className="bg-card border rounded-xl shadow-sm p-5">
        ...
        <div className="overflow-x-auto flex flex-col gap-4">
          <table className="w-full text-sm text-gray-700">
            ...
            <tbody>
              {[
                { name: "Kwame Mensah", dept: "IT", date: "2025-01-15", in: "08:00 AM", out: "05:00 PM", status: "Present", color: "bg-indigo-100 text-indigo-700" },
                { name: "Ama Adjei", dept: "HR", date: "2025-01-15", in: "08:15 AM", out: "05:10 PM", status: "Present", color: "bg-indigo-100 text-indigo-700" },
                { name: "Kofi Asante", dept: "Finance", date: "2025-01-15", in: "09:30 AM", out: "05:00 PM", status: "Late", color: "bg-amber-100 text-amber-700" },
              ].map((row, i) => (
                <tr
                  key={i}
