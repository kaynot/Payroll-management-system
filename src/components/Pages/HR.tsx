...
export default function HR() {
  return (
    ...
    >
      ...
      <section className="bg-card border-[1px] p-6 rounded-lg w-full flex flex-col gap-8 justify-between">
        <div className="flex flex-col gap-8">
          <div className="flex justify-between items-center">
            <h1 className="text-lg font-medium">Employees List</h1>
            <div className="bg-muted border-[1px] py-1 px-4 rounded-full text-sm text-primary-foreground flex gap-4 items-center w-[50%]">
              <Search size={16} color="#9ca3af" />
              <input
                type="text"
                placeholder="Search by name, ID, or department..."
                className="bg-muted text-muted-foreground text-sm outline-none w-[100%]"
              />
            </div>
            ...
            <table className="min-w-full text-sm text-left">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                ...
                <tr className="hover:bg-blue-50 border-b">
                  ...
                  <td className="p-4">Engineering</td>
                  <td className="p-4 flex justify-start">
                    <p className="bg-blue-100 py-1 px-4 rounded-full text-xs text-blue-600 border border-blue-600 font-medium">
                      Full-time
                    </p>
                  </td>
                  <td className="p-4">GH₵ 8,500</td>
                  <td className="p-4 flex justify-center">
                    <p className="bg-green-200 py-1 px-4 rounded-full text-xs text-green-800 border border-green-600 font-medium ">
                      Active
                    </p>
                  </td>
                  <td className="p-4 text-end">
                ...
                <tr className="hover:bg-blue-50 border-b">
                  ...
                  <td className="p-4">Engineering</td>
                  <td className="p-4 flex justify-start">
                    <p className="bg-yellow-100 py-1 px-4 rounded-full text-xs text-yellow-600 border border-yellow-600 font-medium">
                      Intern
                    </p>
                  </td>
                  <td className="p-4">GH₵ 8,500</td>
                ...
                <tr className="hover:bg-blue-50 border-b">
                  ...
                  <td className="p-4">Engineering</td>
                  <td className="p-4 flex justify-start">
                    <p className="bg-orange-100 py-1 px-4 rounded-full text-xs text-orange-600 border border-orange-600 font-medium">
                      Part-time
                    </p>
                  </td>
                  <td className="p-4">GH₵ 8,500</td>
